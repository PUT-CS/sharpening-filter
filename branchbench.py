...
def main(repo_url, clone_dir, branch_names, window_sizes, executable_arguments, iterations, save_path, keep):
    ...
    for branch_name in branch_names:
        ...
        program_path = os.path.join(clone_dir, "sharpening-filter")
...
if __name__ == "__main__":
    ...
    main(repo_url, clone_dir, branch_names, img_sizes, executable_arguments, args.iterations, args.save, args.keep)
